...
export const CreateTerm = (label, startDate, endDate, id) => {
  ...
  return {
    type: CREATE_TERM_SAGA,
    payload: { label: label, startDate: startDate, endDate: endDate, id: id },
  };
};
export const EditTerm = (value, index, Termlist, key) => {
  ...
  return {
    type: EDIT_TERM_SAGA,
    payload: { value: value, index: index, Termlist: Termlist, key: key },
  };
};
export const DeleteEditTerm = (index, Termlist) => {
  console.log("DeleteEditTerm");
  return {
    type: DELETE_EDIT_TERM_SAGA,
    payload: { index: index, termlist: Termlist },
  };
};
export const UpdateTerm = (id, value) => {
  console.log("updateTerm", id, value);
